...
{
	public class SQLServerDialectProvider : BaseDialectProvider
	{
		                                                ...
		                                                string literal = "")
		{
			...
			switch (comparision)
			{
				...
				case DialectComparisonOperator.Like:
					//  using literal value on 'like' for SqlServer (using the parameters collection does not support this correctly):
